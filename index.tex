...
\hypersetup{
  ...
  pdfauthor={Irene García; Alirio Cruz; Ricardo Alberich; Arnau Mir; Francesc Rosselló; Marcos Oliva},
  pdflang={es},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{stock }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(GOOG}\SpecialCharTok{$}\NormalTok{GOOG.Adjusted)}
\NormalTok{stock}\SpecialCharTok{$}\NormalTok{GOOG.Adjusted }\OtherTok{\textless{}{-}}\NormalTok{ stock}\SpecialCharTok{$}\NormalTok{GOOG.Adjusted}\SpecialCharTok{/}\NormalTok{stock}\SpecialCharTok{$}\NormalTok{GOOG.Adjusted[}\DecValTok{1}\NormalTok{]}
\NormalTok{stock }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(stock,}\FunctionTok{rownames}\NormalTok{(stock))}
\FunctionTok{colnames}\NormalTok{(stock) }\OtherTok{\textless{}{-}} \FunctionTok{append}\NormalTok{(}\StringTok{\textquotesingle{}GOOG\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}date\textquotesingle{}}\NormalTok{)}

\NormalTok{fig }\OtherTok{\textless{}{-}} \FunctionTok{plot\_ly}\NormalTok{(stock, }\AttributeTok{type =} \StringTok{\textquotesingle{}scatter\textquotesingle{}}\NormalTok{, }\AttributeTok{mode =} \StringTok{\textquotesingle{}lines\textquotesingle{}}\NormalTok{)}\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{add\_trace}\NormalTok{(}\AttributeTok{x =} \SpecialCharTok{\textasciitilde{}}\NormalTok{date, }\AttributeTok{y =} \SpecialCharTok{\textasciitilde{}}\NormalTok{GOOG, }\AttributeTok{name =} \StringTok{\textquotesingle{}GOOG\textquotesingle{}}\NormalTok{)}\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{layout}\NormalTok{(}\AttributeTok{showlegend =}\NormalTok{ F)}
...
\NormalTok{fig }\OtherTok{\textless{}{-}}\NormalTok{ fig }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{layout}\NormalTok{(}
         \AttributeTok{xaxis =} \FunctionTok{list}\NormalTok{(}\AttributeTok{zerolinecolor =} \StringTok{\textquotesingle{}\#ffff\textquotesingle{}}\NormalTok{,}
                      \AttributeTok{zerolinewidth =} \DecValTok{2}\NormalTok{,}
                      \AttributeTok{gridcolor =} \StringTok{\textquotesingle{}ffff\textquotesingle{}}\NormalTok{),}
         \AttributeTok{yaxis =} \FunctionTok{list}\NormalTok{(}\AttributeTok{zerolinecolor =} \StringTok{\textquotesingle{}\#ffff\textquotesingle{}}\NormalTok{,}
                      \AttributeTok{zerolinewidth =} \DecValTok{2}\NormalTok{,}
                      \AttributeTok{gridcolor =} \StringTok{\textquotesingle{}ffff\textquotesingle{}}\NormalTok{),}
         \AttributeTok{plot\_bgcolor=}\StringTok{\textquotesingle{}\#e5ecf6\textquotesingle{}}\NormalTok{, }\AttributeTok{width =} \DecValTok{900}\NormalTok{)}
...
\includegraphics{t1_intro_files/figure-pdf/unnamed-chunk-109-1.pdf}
...
\bibitem[\citeproctext]{ref-horton}
